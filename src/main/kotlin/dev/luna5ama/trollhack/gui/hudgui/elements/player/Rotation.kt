...
internal object Rotation : LabelHud(
    ...
    override fun SafeClientEvent.updateText() {
        ...
        displayText.add("Yaw", ClickGUI.primary)
        displayText.add(yaw.toString(), ClickGUI.text)
        displayText.add("Pitch", ClickGUI.primary)
        displayText.add(pitch.toString(), ClickGUI.text)
    }
